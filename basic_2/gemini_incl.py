...
"""
        if edu:
            ...
            "and conclusions presented in the cortex of text provided." 
        else:
        ...
        "2.**Format & Style:** *The abstract should be organized in coherent paragraphs, with seamless transitions, following the organization of the source. *Aim for a length of approximately **1 A4 page recto-verso** " \
        ...
        "3.**Result Format** : The result is to be written in LaTeX using utf-8 encoding including : {preamble} and {postamble}." \
        ...
        if(type): # Documents treated seperatly
            ...
            "*Language : Use the same language as the input source (i.e : source in french, write the summary in french)" \
            "3.**Result Format** : The result is to be written in LaTeX using utf-8 and including : {preamble} and {postamble}." \
